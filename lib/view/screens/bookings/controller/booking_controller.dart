...
import 'package:barbar_provider/view/screens/bookings/model/bookings_model.dart';
...
class BookingsController extends GetxController with GetxServiceMixin {
  ...
  RxList<Datum> bookingsModel = <Datum>[].obs;
  ...
  bookings() async {
    ...
    var response = await ApiClient.getData(ApiConstant.bookings);
