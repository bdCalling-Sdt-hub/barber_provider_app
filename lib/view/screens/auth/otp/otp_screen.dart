          ...
          builder: (BuildContext context, BoxConstraints constraints) {
            return SingleChildScrollView(
              ...
              child: Column(
                children: [
                  CustomText(
                    text: "Please enter the OTP we have sent you in your email.".tr,bottom: 24,
                  ...
                  Container(
                    ...
                    child: const CustomImage(
                      imageSrc: AppIcons.otp,imageType: ImageType.png,
                    ),
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Flexible(child: CustomText(text: "Did not get the OTP?".tr,maxLines: 2,textAlign: TextAlign.start)),
                      const SizedBox(width: 24),
                      CustomText(text: "Resend OTP".tr,color: AppColors.primaryOrange,fontWeight: FontWeight.w600),
                    ],
                  ),
                ],
              ),
